...
function Sidebar() {
  return (
    <aside className="hidden md:flex w-64 bg-white border-r border-slate-100 flex-col py-6 px-4 flex-shrink-0">
      <div className="text-sm font-bold text-slate-400 px-3 mb-3 tracking-wider uppercase">{t('nav_menu')}</div>
      {[
        ...
        { to: '/alarms', label: t('nav_alarms'), icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
